...
{
    public partial class ListarCargo : Form
    {
        private string Ruta = ConfigurationManager.AppSettings.Get("CadenaConeccion2");
        ...
        public void Obtener_Cargo(string Nombre)
        {
            ...
            {
                if (servidor.consultar("[dbo].[Pa_Listar_Cargo]", Nombre).Tables.Count > 0)
                    Dt_Origen = servidor.consultar("[dbo].[Pa_Listar_Cargo]", Nombre).Tables[0];
                if (Dt_Origen == null)
                {
        ...
        private void ListarCargo_Load(object sender, EventArgs e)
        {

            Obtener_Cargo(TxtBusca.Text.Trim());
        ...
        private void ListarCargo_KeyDown(object sender, KeyEventArgs e)
        {
